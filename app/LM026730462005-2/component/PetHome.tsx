export default function PetHome({ open, onClose, Pets }) {

    if(!open || !Pets) return null;

    const {id, name, type, contacts } = Pets;
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-gray-500">ติดต่อ : {contacts}</p>      
        </div>
    </div>
    );
}